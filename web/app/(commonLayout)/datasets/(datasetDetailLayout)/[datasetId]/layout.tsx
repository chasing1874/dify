          ...
          <a
            ...
            href={
              locale === LanguagesSupported[1]
                ? 'https://docs.shuling.ai/v/zh-hans/guides/knowledge-base/integrate_knowledge_within_application'
                : 'https://docs.shuling.ai/guides/knowledge-base/integrate-knowledge-within-application'
            }
...
const DatasetDetailLayout: FC<IAppDetailLayoutProps> = (props) => {
  ...
  useEffect(() => {
    if (datasetRes)
      document.title = `${datasetRes.name || 'Dataset'} - SLAI`
  }, [datasetRes])
