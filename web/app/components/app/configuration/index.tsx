...
const Configuration: FC = () => {
  ...
  const setCompletionParams = (value: FormValue) => {
    ...
    if (
      ...
      (!params.stop || params.stop.length === 0) && modeModeTypeRef.current === ModelModeType.completion
    ) {
  ...
  const [fileConfig, doSetFileConfig] = useState({
    enabled: false,
    number_limits: 2,
      ...
      <>
        <div className="flex flex-col h-full">
          <div className="relative flex grow h-[200px] pt-14">
              ...
              <div className="flex items-center justify-between px-6 h-14">
                <div className="flex items-center">
                  ...
                  <div className="flex items-center h-[14px] space-x-1 text-xs">
                    {isAdvancedMode && (
                      <div className="ml-1 flex items-center h-5 px-1.5 border border-gray-100 rounded-md text-[11px] font-medium text-gray-500 uppercase">
            ...
            <div
              className={`w-full sm:w-1/2 shrink-0 flex flex-col h-full ${
            ...
            {!isMobile && (
              <div
                className="relative flex flex-col w-1/2 h-full overflow-y-auto grow "
