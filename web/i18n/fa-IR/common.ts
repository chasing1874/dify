const translation = {
  ...
  imageUploader: {
    ...
    uploadFromComputerTypeLimit: 'نوع تصویر {{type}} است',
  ...
  fileUploader: {
    uploadFromComputer: 'بارگذاری از کامپیوتر',
    uploadFromComputerReadError: 'خواندن فایل ناموفق بود، لطفاً دوباره انتخاب کنید.',
    uploadFromComputerUploadError: 'بارگذاری فایل ناموفق بود، لطفاً دوباره بارگذاری کنید.',
    uploadFromComputerLimit: 'فایل‌های بارگذاری شده نمی‌توانند بیشتر از {{size}} مگابایت باشند',
    uploadFromComputerTypeLimit: 'نوع فایل {{type}} است',
    pasteFileLink: 'پیوند فایل را بچسبانید',
    pasteFileLinkInputPlaceholder: 'پیوند فایل را اینجا بچسبانید',
    pasteFileLinkInvalid: 'پیوند فایل نامعتبر است',
