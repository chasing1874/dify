const translation = {
  ...
  welcome: 'SLAI में आपका स्वागत है, कृपया जारी रखने के लिए लॉग इन करें।',
  email: 'ईमेल पता',
  ...
  license: {
    tip: 'SLAI Community Edition शुरू करने से पहले, GitHub पर',
    link: 'ओपन-सोर्स लाइसेंस',
  },
  join: 'शामिल हों',
  joinTipStart: 'आपको आमंत्रित करते हैं',
  joinTipEnd: 'टीम पर SLAI',
  invalid: 'लिंक समाप्त हो गया है',
  explore: 'SLAI का अन्वेषण करें',
