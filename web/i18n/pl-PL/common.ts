const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Konto SLAI',
    langGeniusAccountTip: 'Twoje konto SLAI i powiązane dane użytkownika.',
  ...
  members: {
    ...
    invitationSentTip:
      'Zaproszenie zostało wysłane, a oni mogą zalogować się do SLAI, aby uzyskać dostęp do danych Twojego zespołu.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Usługa hostowania OpenAI dostarczana przez SLAI pozwala korzystać z modeli takich jak GPT-3.5. Przed wyczerpaniem limitu próbnego należy skonfigurować inne dostawców modeli.',
  ...
  apiBasedExtension: {
    title:
      'Rozszerzenia oparte na interfejsie API zapewniają scentralizowane zarządzanie interfejsami API, upraszczając konfigurację dla łatwego użytkowania w aplikacjach SLAI.',
  ...
  about: {
    ...
    nowAvailable: 'SLAI {{version}} jest teraz dostępny.',
    latestAvailable: 'SLAI {{version}} jest najnowszą dostępną wersją.',
  },
  appMenus: {
