const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Lub wypróbuj wersję chmurową SLAI z darmowym limitem',
  },
  overview: {
    title: 'Przegląd',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip:
            'Pomaga odwiedzającym zrozumieć, jakie dane zbiera aplikacja, zobacz <privacyPolicyLink>Politykę prywatności SLAI</privacyPolicyLink>.',
      ...
      embedded: {
        ...
        chromePlugin: 'Zainstaluj rozszerzenie Chrome SLAI Chatbot',
        copied: 'Skopiowane',
        copy: 'Kopiuj',
      },
      qrcode: {
