const translation = {
  list: {
    title: 'Dokumenty',
    desc: 'Wszystkie pliki wiedzy są tutaj pokazane, a cała wiedza może być powiązana z odnośnikami SLAI lub zindeksowana za pomocą wtyczki Chat.',
    addFile: 'dodaj plik',
    ...
    empty: {
      ...
      sync: {
        tip: 'SLAI regularnie pobiera pliki z Twojego Notion i dokonuje ich przetwarzania.',
      },
    },
    delete: {
