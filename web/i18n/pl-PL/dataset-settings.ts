const translation = {
  ...
  form: {
    ...
    descPlaceholder:
      'Opisz, co znajduje się w tej Wiedzy. Szczegółowy opis pozwala sztucznej inteligencji na dostęp do treści Wiedzy w odpowiednim czasie. Jeśli jest pusty, SLAI użyje domyślnej strategii trafień.',
