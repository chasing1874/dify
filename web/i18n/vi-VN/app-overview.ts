const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Hoặc thử phiên bản điện toán đám mây của SLAI với báo giá miễn phí',
  },
  overview: {
    title: 'Tổng quan',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Giúp khách truy cập hiểu được dữ liệu mà ứng dụng thu thập, xem <privacyPolicyLink>Chính sách bảo mật</privacyPolicyLink> của SLAI.',
      ...
      embedded: {
        ...
        chromePlugin: 'Cài đặt Tiện ích Mở rộng SLAI Chatbot cho Chrome',
        copied: 'Đã sao chép',
        copy: 'Sao chép',
      },
      qrcode: {
