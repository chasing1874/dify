const translation = {
  ...
  form: {
    ...
    descPlaceholder: 'Miêu tả những gì có trong Kiến thức này. Một mô tả chi tiết cho phép AI truy cập nội dung của Kiến thức một cách kịp thời. Nếu trống, SLAI sẽ sử dụng chiến lược hit mặc định.',
