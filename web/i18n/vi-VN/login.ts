const translation = {
  ...
  welcome: 'Chào mừng bạn đến với SLAI, vui lòng đăng nhập để tiếp tục.',
  email: 'Địa chỉ email',
  ...
  license: {
    tip: 'Trước khi bắt đầu sử dụng Phiên bản Cộng đồng của SLAI, vui lòng đọc',
    link: 'Giấy phép mã nguồn mở trên GitHub',
  },
  join: 'Tham gia',
  joinTipStart: 'Mời bạn tham gia',
  joinTipEnd: 'đội ngũ tại SLAI',
  invalid: 'Liên kết đã hết hạn',
  explore: 'Khám phá SLAI',
