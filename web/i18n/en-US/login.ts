const translation = {
  ...
  welcome: 'Welcome to SLAI, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting SLAI Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join',
  joinTipStart: 'Invite you join',
  joinTipEnd: 'team on SLAI',
  invalid: 'The link has expired',
  explore: 'Explore SLAI',
