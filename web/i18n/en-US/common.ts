const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'SLAI account',
    langGeniusAccountTip: 'Your SLAI account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to SLAI to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by SLAI allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across SLAI\'s applications.',
  ...
  about: {
    ...
    nowAvailable: 'SLAI {{version}} is now available.',
    latestAvailable: 'SLAI {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Monitoring',
  ...
  fileUploader: {
    ...
    uploadFromComputerLimit: 'Uploaded files cannot exceed {{size}} MB',
    uploadFromComputerTypeLimit: 'File type is {{type}}',
