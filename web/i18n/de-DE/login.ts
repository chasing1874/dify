const translation = {
  ...
  welcome: 'Willkommen bei SLAI, bitte melde dich an, um fortzufahren.',
  ...
  license: {
    tip: 'Bevor du mit SLAI Community Edition beginnst, lies die',
    link: 'Open-Source-Lizenz',
  },
  join: 'Beitreten',
  joinTipStart: 'Lade dich ein, dem',
  joinTipEnd: 'Team auf SLAI beizutreten',
  invalid: 'Der Link ist abgelaufen',
  explore: 'SLAI erkunden',
