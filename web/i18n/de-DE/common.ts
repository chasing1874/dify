const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'SLAI-Konto',
    langGeniusAccountTip: 'Ihr SLAI-Konto und zugehörige Benutzerdaten.',
  ...
  members: {
    ...
    invitationSentTip: 'Einladung gesendet, und sie können sich bei SLAI anmelden, um auf Ihre Teamdaten zuzugreifen.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Der OpenAI-Hostingdienst von SLAI ermöglicht es Ihnen, Modelle wie GPT-3.5 zu verwenden. Bevor Ihr Probe-Kontingent aufgebraucht ist, müssen Sie andere Modellanbieter einrichten.',
  ...
  apiBasedExtension: {
    title: 'API-Erweiterungen bieten zentralisiertes API-Management und vereinfachen die Konfiguration für eine einfache Verwendung in SLAIs Anwendungen.',
  ...
  about: {
    ...
    nowAvailable: 'SLAI {{version}} ist jetzt verfügbar.',
    latestAvailable: 'SLAI {{version}} ist die neueste verfügbare Version.',
  },
  appMenus: {
    overview: 'Übersicht',
  ...
  imageUploader: {
    ...
    uploadFromComputerTypeLimit: 'Image type is {{type}}',
  ...
  fileUploader: {
    uploadFromComputer: 'Vom Computer hochladen',
    uploadFromComputerReadError: 'Dateilesung fehlgeschlagen, bitte erneut versuchen.',
    uploadFromComputerUploadError: 'Datei-Upload fehlgeschlagen, bitte erneut hochladen.',
    uploadFromComputerLimit: 'Hochgeladene Dateien dürfen {{size}} MB nicht überschreiten',
    uploadFromComputerTypeLimit: 'Dateityp ist {{type}}',
    pasteFileLink: 'Dateilink einfügen',
    pasteFileLinkInputPlaceholder: 'Dateilink hier einfügen',
