const translation = {
  ...
  imageUploader: {
    ...
    uploadFromComputerTypeLimit: 'Görüntü türü {{type}} olmalıdır',
  ...
  fileUploader: {
    uploadFromComputer: 'Bilgisayardan Yükle',
    uploadFromComputerReadError: 'Dosya okuma başarısız oldu, lütfen yeniden seçin.',
    uploadFromComputerUploadError: 'Dosya yükleme başarısız oldu, lütfen yeniden yükleyin.',
    uploadFromComputerLimit: 'Yüklenen dosya {{size}} MB\'yi aşamaz',
    uploadFromComputerTypeLimit: 'Dosya türü {{type}} olmalıdır',
