const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Обліковий запис SLAI',
    langGeniusAccountTip: 'Ваш обліковий запис SLAI та пов’язані з ним дані користувача.',
  ...
  members: {
    ...
    invitationSentTip: 'Запрошення надіслано, і вони можуть увійти в SLAI, щоб отримати доступ до даних вашої команди.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Служба хостингу OpenAI, надана SLAI, дозволяє використовувати такі моделі, як GPT-3.5. Перш ніж ваша пробна квота буде використана, вам потрібно налаштувати інші постачальники моделі.',
  ...
  apiBasedExtension: {
    title: 'API-розширення забезпечують централізоване керування API, спрощуючи конфігурацію для зручного використання в різних програмах SLAI.',
  ...
  about: {
    ...
    nowAvailable: 'SLAI {{version}} тепер доступна.',
    latestAvailable: 'SLAI {{version}} – це найновіша доступна версія.',
  },
  appMenus: {
    overview: 'Моніторинг',
  ...
  imageUploader: {
    ...
    uploadFromComputerTypeLimit: 'Тип зображення має бути {{type}}',
  ...
  fileUploader: {
    uploadFromComputer: 'Завантажити з комп\'ютера',
    uploadFromComputerReadError: 'Помилка зчитування файлу, виберіть інший файл.',
    uploadFromComputerUploadError: 'Помилка завантаження файлу, спробуйте знову.',
    uploadFromComputerLimit: 'Розмір файлу не може перевищувати {{size}} МБ',
    uploadFromComputerTypeLimit: 'Тип файлу має бути {{type}}',
    pasteFileLink: 'Вставити посилання на файл',
    pasteFileLinkInputPlaceholder: 'Вставте посилання на файл тут',
