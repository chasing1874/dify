const translation = {
  ...
  welcome: 'Ласкаво просимо до SLAI, будь ласка, увійдіть, щоб продовжити.',
  ...
  license: {
    tip: 'Перед запуском SLAI Community Edition ознайомтеся з ліцензією з відкритим кодом на GitHub',
    link: 'Ліцензія з відкритим кодом',
  },
  join: 'Приєднуйтесь',
  joinTipStart: 'Запрошуємо вас приєднатися',
  joinTipEnd: 'команда SLAI',
  invalid: 'Посилання застаріло',
  explore: 'Досліджуйте SLAI',
