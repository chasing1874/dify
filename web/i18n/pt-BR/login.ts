const translation = {
  ...
  welcome: 'Bem-vindo ao SLAI, faça login para continuar.',
  ...
  license: {
    tip: 'Antes de começar a usar a Edição Comunitária do SLAI, leia a',
    link: 'Licença de código aberto do GitHub',
  },
  join: 'Participar',
  joinTipStart: 'Convidamos você a participar da',
  joinTipEnd: 'equipe no SLAI',
  invalid: 'O link expirou',
  explore: 'Explorar o SLAI',
