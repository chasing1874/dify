const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Conta SLAI',
    langGeniusAccountTip: 'Sua conta SLAI e dados de usuário associados.',
  ...
  members: {
    ...
    invitationSentTip: 'Convite enviado e eles podem fazer login no SLAI para acessar os dados da sua equipe.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'O serviço de hospedagem OpenAI fornecido pela SLAI permite que você use modelos como GPT-3.5. Antes que sua cota de teste seja esgotada, você precisa configurar outros fornecedores de modelos.',
      callTimes: 'Chamadas',
  ...
  apiBasedExtension: {
    title: 'As extensões de API fornecem gerenciamento centralizado de API, simplificando a configuração para uso fácil em todos os aplicativos da SLAI.',
    link: 'Saiba como desenvolver sua própria Extensão de API.',
    linkUrl: 'https://docs.SLAI.ai/features/extension/api_based_extension',
  ...
  about: {
    ...
    nowAvailable: 'SLAI {{version}} já está disponível.',
    latestAvailable: 'SLAI {{version}} é a última versão disponível.',
  },
  appMenus: {
  ...
  imageUploader: {
    ...
    uploadFromComputerTypeLimit: '图片类型为{{type}}',
  ...
  fileUploader: {
    ...
    uploadFromComputerReadError: 'Falha ao ler o arquivo, por favor, selecione novamente.',
    uploadFromComputerUploadError: 'Falha ao enviar o arquivo, por favor, tente novamente.',
    uploadFromComputerLimit: 'O arquivo enviado não pode exceder {{size}} MB',
    uploadFromComputerTypeLimit: 'O tipo de arquivo deve ser {{type}}',
