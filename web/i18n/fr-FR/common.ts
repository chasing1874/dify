const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Compte SLAI',
    langGeniusAccountTip: 'Votre compte SLAI et les données utilisateur associées.',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation envoyée, et ils peuvent se connecter à SLAI pour accéder aux données de votre équipe.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Le service d\'hébergement OpenAI fourni par SLAI vous permet d\'utiliser des modèles tels que GPT-3.5. Avant que votre quota d\'essai ne soit épuisé, vous devez configurer d\'autres fournisseurs de modèles.',
  ...
  apiBasedExtension: {
    title: 'Les extensions API fournissent une gestion centralisée des API, simplifiant la configuration pour une utilisation facile à travers les applications de SLAI.',
    link: 'Apprenez comment développer votre propre Extension API.',
    linkUrl: 'https://docs.shuling.ai/fonctionnalites/extension/extension_basee_sur_api',
  ...
  about: {
    ...
    nowAvailable: 'SLAI {{version}} est maintenant disponible.',
    latestAvailable: 'SLAI {{version}} est la dernière version disponible.',
  },
  appMenus: {
  ...
  imageUploader: {
    ...
    uploadFromComputerTypeLimit: 'Le type d\'image est {{type}}',
  ...
  fileUploader: {
    uploadFromComputer: 'Télécharger depuis l\'ordinateur',
    uploadFromComputerReadError: 'La lecture du fichier a échoué, veuillez sélectionner à nouveau.',
    uploadFromComputerUploadError: 'Le téléchargement du fichier a échoué, veuillez essayer de nouveau.',
    uploadFromComputerLimit: 'Les fichiers téléchargés ne peuvent pas dépasser {{size}} Mo',
    uploadFromComputerTypeLimit: 'Le type de fichier est {{type}}',
    pasteFileLink: 'Coller le lien du fichier',
    pasteFileLinkInputPlaceholder: 'Collez le lien du fichier ici',
    pasteFileLinkInvalid: 'Lien du fichier invalide',
