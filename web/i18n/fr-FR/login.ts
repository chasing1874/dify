const translation = {
  ...
  welcome: 'Bienvenue sur SLAI, veuillez vous connecter pour continuer.',
  ...
  license: {
    tip: 'Avant de commencer SLAI Community Edition, lisez le GitHub',
    link: 'Licence Open-source',
  },
  join: 'Rejoindre',
  joinTipStart: 'Je vous invite à rejoindre',
  joinTipEnd: 'équipe sur SLAI',
  invalid: 'Le lien a expiré',
  explore: 'Explorez SLAI',
