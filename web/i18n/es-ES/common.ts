const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Cuenta SLAI',
    langGeniusAccountTip: 'Tu cuenta SLAI y los datos de usuario asociados.',
  ...
  members: {
    ...
    invitationSentTip: 'Invitación enviada, y pueden iniciar sesión en SLAI para acceder a tus datos del equipo.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'El servicio de hospedaje OpenAI proporcionado por SLAI te permite usar modelos como GPT-3.5. Antes de que se agote tu cuota de prueba, necesitas configurar otros proveedores de modelos.',
  ...
  apiBasedExtension: {
    title: 'Las extensiones basadas en API proporcionan una gestión centralizada de API, simplificando la configuración para su fácil uso en las aplicaciones de SLAI.',
  ...
  about: {
    ...
    nowAvailable: 'SLAI {{version}} ya está disponible.',
    latestAvailable: 'SLAI {{version}} es la última versión disponible.',
  },
  appMenus: {
    overview: 'Monitoreo',
    promptEng: 'Orquestar',
  ...
  imageUploader: {
    ...
    uploadFromComputerTypeLimit: 'El tipo de archivo es {{type}}',
  ...
  fileUploader: {
    uploadFromComputer: 'Cargar desde la computadora',
    uploadFromComputerReadError: 'Lectura del archivo fallida, por favor intenta nuevamente.',
    uploadFromComputerUploadError: 'Carga del archivo fallida, por favor carga nuevamente.',
    uploadFromComputerLimit: 'Los archivos cargados no pueden exceder {{size}} MB',
    uploadFromComputerTypeLimit: 'El tipo de archivo es {{type}}',
    pasteFileLink: 'Pegar enlace del archivo',
    pasteFileLinkInputPlaceholder: 'Pega el enlace del archivo aquí',
    pasteFileLinkInvalid: 'Enlace del archivo no válido',
