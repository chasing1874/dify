const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Cont SLAI',
    langGeniusAccountTip: 'Contul SLAI și datele de utilizator asociate.',
  ...
  members: {
    ...
    invitationSentTip: 'Invitația a fost trimisă și pot să se autentifice în SLAI pentru a accesa datele echipei dvs.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Serviciul de găzduire OpenAI furnizat de SLAI vă permite să utilizați modele precum GPT-3.5. Înainte ca cota de probă să fie epuizată, trebuie să configurați alți furnizori de modele.',
      callTimes: 'Apeluri',
  ...
  apiBasedExtension: {
    title: 'Extensiile bazate pe API oferă o gestionare centralizată a API-urilor, simplificând configurația pentru o utilizare ușoară în aplicațiile SLAI.',
  ...
  about: {
    ...
    nowAvailable: 'SLAI {{version}} este acum disponibil.',
    latestAvailable: 'SLAI {{version}} este ultima versiune disponibilă.',
  },
  appMenus: {
  ...
  imageUploader: {
    ...
    uploadFromComputerTypeLimit: 'Tipul imaginii trebuie să fie {{type}}',
  ...
  fileUploader: {
    ...
    uploadFromComputerLimit: 'Fișierul încărcat nu poate depăși {{size}} MB',
    uploadFromComputerTypeLimit: 'Tipul fișierului trebuie să fie {{type}}',
    pasteFileLink: 'Inserați link-ul fișierului',
    pasteFileLinkInputPlaceholder: 'Inserați link-ul fișierului aici',
    pasteFileLinkInvalid: 'Link-ul fișierului este nevalid',
