const translation = {
  ...
  welcome: 'Bine ai venit la SLAI, te rugăm să te autentifici pentru a continua.',
  ...
  license: {
    tip: 'Înainte de a începe SLAI Community Edition, citește',
