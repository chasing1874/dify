const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Sau încercați versiunea cloud a SLAI cu cotă gratuită',
  },
  overview: {
    ...
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Ajută vizitatorii să înțeleagă datele pe care le colectează aplicația, consultați <privacyPolicyLink>Politica de confidențialitate</privacyPolicyLink> a SLAI.',
        },
      },
      embedded: {
        entry: 'Încorporat',
        ...
        chromePlugin: 'Instalați extensia Chrome SLAI Chatbot',
        copied: 'Copiat',
        copy: 'Copiați',
      },
      qrcode: {
